	  	...
	  	<div class="span12">
			...
			<a class="brand" href="#"><p align="center"><img src="imagens/procodeMenu.png"/></p></a>
				<ul class="nav">
					...
					<li class="active"><a href="certificadosEmitidos.php"><i class="icon-envelope"></i>  Certificados Emitidos</a></li>
...
<div class="span12">
	...
	<!-- CONTEÚDO DO SITE!!!-->
	 ...
	 <h1 align="center"><font face="cooper" color="#6699FF"> Certificados Emitidos</font></h1>
