...
<div class="span12">
			...
			<a class="brand" href="#"><p align="center"><img src="imagens/procodeMenu.png"/></p></a>
				<ul class="nav">
					...
					<li class="active"><a href="cursos.php"><i class="icon-book"></i>  Cursos</a></li>
...
<!--Corpo do site-->
	...
	<h1 align="center"><font face="cooper" color="#6699FF">Todos os Cursos</font></h1>
<br><br><br>
				    ...
				    <div class="thumbnail">
				      <?php echo " <img src=\"".$curso['foto']."\" > "; ?>
				        ...
				        <p>
				          ...
				          <a class="btn" disabled="disabled" ><i class=" icon-bookmark"></i>Lista de desejos</a></form>
				        </p>          
				        </div>
				    </div>
				  </li>
